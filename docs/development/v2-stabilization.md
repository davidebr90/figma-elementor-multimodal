...
| Responsive | Layout, paint e bordi desktop/tablet/mobile disponibili; il client normalizza anche i metadati `fem-responsive` legacy in gruppi `layout`/`style`/`text` | Confronti visivi su breakpoint e larghezze intermedie per i casi dichiarati supportati |
